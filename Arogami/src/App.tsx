...
import PatientRecords from "./components/consultation/Doctor/PatientRecords.tsx";
...
import PatientVitals from "./components/consultation/patient/PatientVitals.tsx";
...
const router = createBrowserRouter([
    ...
    {
        path: "/consultation/doctor/patient-records",
    ...
    {
        path: "/consultation/patient/vitals",
...
function App() {
    const googleClientId = import.meta.env.VITE_GOOGLE_CLIENT_ID || "384056501722-rjpmvsabipg8qhovo9nb2637sce1kp2a.apps.googleusercontent.com";
