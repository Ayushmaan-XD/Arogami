...
const DoctorLogin = ({ onLoginSuccess }) => {
  ...
  console.log('DoctorLogin component rendered'); // Debug log
  console.log('Google Client ID available:', !!import.meta.env.VITE_GOOGLE_CLIENT_ID); // Debug log
      ...
      <div className="flex flex-col lg:flex-row items-center bg-white shadow-lg rounded-lg overflow-hidden max-w-4xl">
        <div className="p-8 lg:w-1/2 flex flex-col justify-center">
          ...
          <p className="text-gray-600 text-center mb-6">
            Manage your schedules and perform consultations efficiently.
          </p>
          <div className="flex justify-center mb-6">
            <div style={{ minHeight: '50px', border: '1px dashed red', padding: '10px' }}>
              {/* Debug wrapper */}
              <GoogleLogin
        ...
        <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-b from-[#175134] to-[#28a745] items-center justify-center">
          <div className="text-white p-8 text-center">
            ...
            <p className="text-lg">
              Streamline your workflow and enhance patient care with Arogami.
            </p>
          </div>
        </div>
      </div>
