...
import {
  clientIdState,
  collectedSymptomsState,
} from "../../atoms/symptomAtoms.ts";
      ...
      <div className="bg-blue-50 rounded-lg p-6 mb-8 flex items-start">
        ...
        <div>
          ...
          <p className="text-blue-600 mb-4">
            Based on your symptoms, we recommend scheduling an online
            consultation with a qualified medical professional for a proper
        ...
        <div className="flex">
          ...
          <div className="ml-3">
            <p className="text-sm text-yellow-700">
              ...
              and does not constitute professional medical advice. Always
              consult with a qualified healthcare provider for proper diagnosis
              and treatment.
            </p>
          </div>
        </div>
