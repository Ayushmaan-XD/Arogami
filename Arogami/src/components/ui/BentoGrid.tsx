    ...
    return (
        <div
            className={`group relative col-span-1 flex flex-col justify-between overflow-hidden rounded-xl
                  ...
                  ${className}`}
        >
            <div className="pointer-events-none z-10 flex transform-gpu flex-col gap-1 p-4 sm:p-6 transition-all duration-300 group-hover:scale-90 group-hover:translate-y-2">
